...
bcon1 = PhotoImage(file=r'brightness1.png')
bcon2 = PhotoImage(file=r'Log2.png')
bcon3 = PhotoImage(file=r'gamma3.png')
bcon4 = PhotoImage(file=r'stretch4.png')
bcon5 = PhotoImage(file=r'hist5.png')
bcon6 = PhotoImage(file=r'edge6.png')
bcon7 = PhotoImage(file=r'blur7.png')
bcon8 = PhotoImage(file=r'sharp8.png')
bcon9 = PhotoImage(file=r'hist eq9.png')
bcon11 = PhotoImage(file=r'uniform.png')
bcon12 = PhotoImage(file=r'salt10.png')
bcon13 = PhotoImage(file=r'gussin11.png')
bcon14 = PhotoImage(file=r'gray14.png')
bcon15 = PhotoImage(file=r'Fourier.png')
bcon16 = PhotoImage(file=r'inverseFourier.png')
bcon17 = PhotoImage(file=r'min.png')
bcon18 = PhotoImage(file=r'max.png')
bcon19 = PhotoImage(file=r'median.png')
# --------------------End Of Icons------------------
